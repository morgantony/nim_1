package com.netease.nim.weyouchats.session;
...
import com.netease.nim.weyouchats.contact.activity.RobotProfileActivity;
...
import com.netease.nim.weyouchats.session.action.AVChatAction;
import com.netease.nim.weyouchats.session.action.AckMessageAction;
import com.netease.nim.weyouchats.session.action.FileAction;
import com.netease.nim.weyouchats.session.action.GuessAction;
import com.netease.nim.weyouchats.session.action.RedPacketAction;
import com.netease.nim.weyouchats.session.action.SnapChatAction;
import com.netease.nim.weyouchats.session.action.TeamAVChatAction;
import com.netease.nim.weyouchats.session.activity.AckMsgInfoActivity;
import com.netease.nim.weyouchats.session.activity.MessageHistoryActivity;
import com.netease.nim.weyouchats.session.activity.MessageInfoActivity;
import com.netease.nim.weyouchats.session.extension.CustomAttachParser;
import com.netease.nim.weyouchats.session.extension.CustomAttachment;
...
import com.netease.nim.weyouchats.session.extension.RedPacketAttachment;
import com.netease.nim.weyouchats.session.extension.RedPacketOpenedAttachment;
import com.netease.nim.weyouchats.session.extension.SnapChatAttachment;
import com.netease.nim.weyouchats.session.extension.StickerAttachment;
import com.netease.nim.weyouchats.session.search.SearchMessageActivity;
import com.netease.nim.weyouchats.session.viewholder.MsgViewHolderAVChat;
import com.netease.nim.weyouchats.session.viewholder.MsgViewHolderDefCustom;
import com.netease.nim.weyouchats.session.viewholder.MsgViewHolderFile;
import com.netease.nim.weyouchats.session.viewholder.MsgViewHolderGuess;
import com.netease.nim.weyouchats.session.viewholder.MsgViewHolderOpenRedPacket;
import com.netease.nim.weyouchats.session.viewholder.MsgViewHolderRTS;
import com.netease.nim.weyouchats.session.viewholder.MsgViewHolderRedPacket;
import com.netease.nim.weyouchats.session.viewholder.MsgViewHolderSnapChat;
import com.netease.nim.weyouchats.session.viewholder.MsgViewHolderSticker;
import com.netease.nim.weyouchats.session.viewholder.MsgViewHolderTip;
